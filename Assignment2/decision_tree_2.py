...
# SPECIFICATION: Decision Tree 2 - train, test, and output the performace of 3 different models on the given test set.
...
for ds in dataSets:
    ...
    lowestAccuracy = 1  # lowest accuracy of the model 
    ...
    for i in range (10):
       ...
       trueCount = 0 # number of correct predictions (true positive and true negative) 
       for data in dbTest:
