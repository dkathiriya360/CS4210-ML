...
# AUTHOR: Dharam
# FILENAME: svm.py
# SPECIFICATION: Build multiple SVM classifiers
        ...
        for k_val in kernel: #iterates kernel
           for dfs_val in decision_function_shape: #iterates over decision_function_shape
                ...
                if accuracy > highestAccuracy:
                    ...
                    print(f"Highest SVM accuracy so far: {highestAccuracy}, Parameters: C={c_val}, degree={d_val}, kernel={k_val}, decision_function_shape={dfs_val}")
